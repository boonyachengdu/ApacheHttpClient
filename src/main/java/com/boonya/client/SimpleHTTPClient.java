...
public class SimpleHTTPClient {
	...
	private static class SingletonHttpClient {
		 ...
		 * 单例对象实例
		 */
		static final SimpleHTTPClient INSTANCE = new SimpleHTTPClient();
	}
	 ...
	 * @throws
	 */
	private void setMethodPost(String url){
		methodPost = new HttpPost(url);
	 ...
	 * @throws
	 */
	private void setMethodPost(String url,String uuid){
		methodPost = new HttpPost(url);
		methodPost.setHeader("Accept", "application/json");
		methodPost.setHeader("Accpet-Encoding", "gzip");
		methodPost.setHeader("Content-Encoding", "UTF-8");
		methodPost.setHeader("Content-Type", "application/json; charset=UTF-8");
		methodPost.setHeader("Sequence", uuid);
	}
	 ...
	 * @return
	 */
	public String post(String url,String parameters,String uuid) {
		setMethodPost(url,uuid);
		// 设置忽略访问SSL
		initHttps();
		String body = null;
		logger.info("parameters:" + parameters);
